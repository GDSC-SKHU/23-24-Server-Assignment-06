...
import com.example.oauth2example.auth.domain.Role;
import com.example.oauth2example.auth.domain.User;
import com.example.oauth2example.auth.dto.Token;
import com.example.oauth2example.auth.dto.UserInfo;
import com.example.oauth2example.auth.jwt.TokenProvider;
